...
def responseBuilder(RESPONSE_TYPE, request):
    ...
    GENERIC_ERRORS = ["ENDPOINT_UNREACHABLE", "NO_SUCH_ENDPOINT", "INVALID_VALUE", "INVALID_DIRECTIVE",
                      "INVALID_AUTHORIZATION_CREDENTIAL", "EXPIRED_AUTHORIZATION_CREDENTIAL", "INTERNAL_ERROR"]
...
if __name__ == "__main__":
    ...
    logging.basicConfig(filename=logTopic, filemode='a',
